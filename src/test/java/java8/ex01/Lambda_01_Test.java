...
public class Lambda_01_Test {
    ...
    // tag::filter[]
    private List<Person> filter(List<Person> persons, PersonPredicate predicat) {
        
        	 List<Person> filteredPersons = new ArrayList<Person>(0);
        	 if (predicat != null) { 
    ...
    public void test_filter_by_age() throws Exception {
        ...
        PersonPredicate predicat = p -> p.getAge()>=18;
    ...
    public void test_filter_by_firstname() throws Exception {
        ...
        List<Person> personList = Data.buildPersonList(100);
        PersonPredicate predicat = p -> p.getFirstname().equals("first_10");
    ...
    public void test_filter_by_password() throws Exception {
        ...
        PersonPredicate predicat = p -> p.getAge() >=50  && p.getPassword().equals("test");
